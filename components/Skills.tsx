                    ...
                    .map(([category, skills]) => {
                        ...
                        return (
                            <motion.div
                                key={category}
                                variants={fadeInUp}
                                className="bg-[#080A1F]/80 backdrop-blur-sm border border-[#00F0FF]/20 rounded-xl p-6 hover:border-[#00F0FF] hover:shadow-[0_0_20px_rgba(163,53,255,0.15)] transition-all duration-300 group max-w-5xl mx-auto mt-6"
                            >
                                <div className="flex items-center gap-3 mb-6 border-b border-[#00F0FF]/10 pb-4">
                                    <Icon className="text-[#00F0FF]" size={24} />
                                    <h3 className="text-xl font-bold text-white font-mono">{category.toUpperCase()}</h3>
